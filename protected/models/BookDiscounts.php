...
/**
 * This is the model class for table "ym_book_discounts".
 *
 * The followings are the available columns in table 'ym_book_discounts':
...
class BookDiscounts extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			...
			array('book_id, start_date, end_date, percent', 'safe', 'on'=>'search'),
		);
	}
	...
	public function getOffPrice(){
		return $this->book->price - $this->book->price * $this->percent /100;
	}
}
