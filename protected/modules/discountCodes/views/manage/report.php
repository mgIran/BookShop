...
/* @var $model DiscountUsed */

Yii::app()->clientScript->registerScript("send-discount-used-form", '
    var report_type;

    $("body").on("submit", "#filter-form", function(e){
        e.preventDefault();
        var $filters = $(this).serialize();
        $.fn.yiiGridView.update("report-discount-used-list",{
            data: $filters
        });
    });
...
<h1>گزارش استفاده از کدهای تخفیف</h1>
...
<!--        --><?php //echo CHtml::dropDownList('DiscountUsed[method]', $model->method?$model->method:'', $model->methodLabels,array(
//            'class' => 'selectpicker',
//            'data-width' => '100%',
...
<!--    </div>-->
    <div class="row">
        ...
        <div class="form-group">
            <?php
            echo CHtml::radioButton('DiscountUsed[report_type]',(!$model->report_type || ($model->report_type && $model->report_type == '')?true:false), array(
        ...
        <div class="form-group">
            <?php
            echo CHtml::radioButton('DiscountUsed[report_type]',$model->report_type && $model->report_type == 'yearly'?true:false, array(
        ...
        <div class="form-group">
            <?php
            echo CHtml::radioButton('DiscountUsed[report_type]',$model->report_type && $model->report_type == 'monthly'?true:false, array(
        ...
        <div class="form-group">
            <?php
            echo CHtml::radioButton('DiscountUsed[report_type]',$model->report_type && $model->report_type == 'by-date'?true:false, array(
