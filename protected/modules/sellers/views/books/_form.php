...
<!--            </div>-->
            ...
            <div class="form-group col-lg-6 col-md-6 col-sm-6 col-xs-12">
                ...
                <?php $this->widget('ext.dropZoneUploader.dropZoneUploader', array(
                    ...
                    'maxFiles' => 1,
                    'maxFileSize' => 0.5, //MB
                    'url' => Yii::app()->createUrl('/sellers/books/upload'),
                    'deleteUrl' => Yii::app()->createUrl('/sellers/books/deleteUpload'),
            ...
            <div class="form-group col-lg-6 col-md-6 col-sm-6 col-xs-12">
                ...
                <?php $this->widget('ext.dropZoneUploader.dropZoneUploader', array(
                    ...
                    'maxFiles' => 1,
                    'maxFileSize' => 5, //MB
                    'url' => Yii::app()->createUrl('/sellers/books/uploadPreview'),
                    'deleteUrl' => Yii::app()->createUrl('/sellers/books/deleteUploadPreview'),
