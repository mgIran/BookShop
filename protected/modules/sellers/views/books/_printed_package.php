<?php
/* @var $this SellersBooksController */
/* @var $model Books */
...
<div class="packages-list-container">
    ...
    <table class="table">
        ...
        <?php $this->widget('zii.widgets.CListView', array(
            ...
            'ajaxUrl'=>array('/sellers/books/update/'.$model->id),
            'itemsTagName'=>'tr',
            'tagName'=>'tbody',
                            ...
                            <?php echo CHtml::beginForm('','post',array('id'=>'package-info-form'));?>
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        ...
                                        <?php echo CHtml::ajaxSubmitButton('ثبت', $this->createUrl('/sellers/books/savePackage'), array(
                                            'type'=>'POST',
                                            'dataType'=>'JSON',
