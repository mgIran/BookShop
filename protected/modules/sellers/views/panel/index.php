...
<div class="transparent-form">
    ...
    <div class="buttons">
        <a class="btn btn-success" href="<?php echo $this->createUrl('/sellers/books/search');?>">افزودن کتاب جدید</a>
    </div>
<!--    <th>قیمت</th>-->
        ...
        'columns' => array(
            ...
            array(
                ...
                'buttons'=>array(
                    ...
                    'delete'=>array(
                        'label'=>'',
                        'url'=>'Yii::app()->createUrl("/sellers/books/delete", array("id"=>$data->id))',
                        'imageUrl'=>false,
                        'options'=>array('class'=>'icon-trash text-danger ask-sure'),
                        'visible' => '$data->seller_id == Yii::app()->user->getId()'
                    ),
                ),
            )
        )
