...
<div class="tab-content">
    ...
    <div id="real" class="tab-pane fade in active">
        <div class="form">
            ...
            <div class="form-group">
                <?php echo $form->textField($model,'publication_name',array('placeholder'=>'نام فروشنده *','maxlength'=>100,'class'=>'form-control')); ?>
            ...
            <div class="form-group">
                <label>کیمیسیون</label>
                <?php echo $form->textField($model,'commission',array('placeholder'=>'کمیسیون (درصد)','class'=>'form-control','disabled'=>is_null($model->commission)?true:false)); ?>
                <div>
