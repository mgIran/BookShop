...
class SellersPanelController extends Controller
{
    /**
	...
	public function actionIndex()
	{
        ...
        $books->seller_id = Yii::app()->user->getId();
        $books->sellerBooks = true;
    ...
    public function actionDiscount()
    {
        ...
        if (isset($_GET['ajax']) && $_GET['ajax'] === 'books-discount-form') {
            ...
            $model->setScenario('save-printed-discount');
        ...
        $criteria = new CDbCriteria();
        $criteria->with[] = 'book';
        $criteria->addCondition('book.seller_id = :user_id');
        ...
        $criteria = new CDbCriteria();
        $criteria->addCondition('seller_id = :user_id');
    ...
    public function actionUpdate($id)
    {
        ...
        $model->userDetails->scenario = 'update_seller_' . $model->userDetails->type . '_profile_admin';
