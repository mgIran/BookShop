...
class BaseManageController extends Controller
{
    ...
    public function actionCreate()
    {
        ...
        $this->render('manageBooks.views.baseManage.create', array(
            'model' => $model,
            'icon' => $icon,
    ...
    public function actionUpdate($id)
    {
        ...
        Yii::app()->getModule('setting');
        $this->render('manageBooks.views.baseManage.update', array(
            'model' => $model,
            'icon' => $icon,
            'images' => $images,
            'step' => 1,
    ...
    public function actionIndex()
    {
        ...
        $this->render('manageBooks.views.baseManage.index', array(
    ...
    public function actionAdmin()
    {
        ...
        $this->render('manageBooks.views.baseManage.admin', array(
            'model' => $model,
        ));
    }
