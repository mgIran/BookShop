...
$this->menu=array(
	array('label'=>'افزودن برنامه', 'url'=>Yii::app()->createUrl('/manageBooks/'.$this->controller.'/create')),
);
?>
	...
	'columns'=>array(
		...
		*/
		array(
            ...
            'buttons' => array(
                'update' => array(
                    'url' => 'Yii::app()->createUrl("/manageBooks/'.$this->controller.'/update", array("id"=>$data->id))'
                ),
                'delete' => array(
                    'url' => 'Yii::app()->createUrl("/manageBooks/'.$this->controller.'/delete", array("id"=>$data->id))'
                ),
                'view' => array(
