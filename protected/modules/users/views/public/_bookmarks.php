...
<div class="container-fluid">
    <?php if(empty($model->bookmarkedBooks)):?>
        نتیجه ای یافت نشد.
    <?php else:?>
        <?php foreach($model->bookmarkedBooks as $app):?>
            <div class="col-lg-4 col-md-4 col-sm-6 col-xs-12 bookmarked-app">
                <a href="<?php echo $this->createUrl('/books/'.$app->id.'/'.urlencode(CHtml::encode($app->title)));?>"></a>
                ...
                <div class="col-lg-7 col-md-7 col-sm-7 col-xs-7 info">
                    ...
                    <p class="small"><?php echo (is_null($app->publisher_id))?$app->publisher_name:$app->publisher->userDetails->fa_name;?></p>
