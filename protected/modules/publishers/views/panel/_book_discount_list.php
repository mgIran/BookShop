...
<div class="tr">
    <div class="col-lg-3 col-md3 col-sm-3 col-xs-4"><a target="_blank" href="<?= $this->createUrl('/book/'.$data->book->id.'/'.urlencode($data->book->title)) ?>"><?php echo $data->book->title;?></a></div>
