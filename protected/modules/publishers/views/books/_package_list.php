...
<div class="tr">
    ...
    <div class="col-lg-2 col-md-2 hidden-sm hidden-xs"><?php echo Controller::fileSize(Yii::getPathOfAlias("webroot") . '/uploads/books/files/'.$data->book->platform->name.'/'.$data->file_name);?></div>
    ...
    <div class="col-lg-1 col-md-1 hidden-sm hidden-xs"><?php Controller::parseNumbers(number_format($data->price)).' تومان'?></div>
    <div class="col-lg-1 col-md-1 hidden-sm hidden-xs"><?php Controller::parseNumbers(number_format($data->printed_price)).' تومان'?></div>
