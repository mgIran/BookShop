...
<div class="white-form">
    <h3>ویرایش نسخه <?= $model->type == BookPackages::TYPE_ELECTRONIC ? 'الکترونیکی' : 'چاپی '?><?= $model->version ?> کتاب <?= $model->book->title ?></h3>
    ...
    <div class="container-fluid">
        ...
        <?php $form=$this->beginWidget('CActiveForm', array(
            ...
            <?php if($model->type == BookPackages::TYPE_ELECTRONIC):?>
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 form-group">
                    ...
                    <?php echo $form->error($model , 'tempFile'); ?>
