...
<div class="tr">
    ...
    <div class="col-lg-2 col-md-2 hidden-sm hidden-xs"><?php echo number_format(filesize(Yii::getPathOfAlias("webroot") . '/uploads/books/files/'.$data->book->platform->name.'/'.$data->file_name)/1024/1024, 2).' مگابایت';?></div>
