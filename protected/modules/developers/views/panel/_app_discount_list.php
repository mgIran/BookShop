...
<div class="tr">
    <div class="col-lg-3 col-md3 col-sm-3 col-xs-4"><a target="_blank" href="<?= $this->createUrl('/books/'.$data->app->id.'/'.urlencode($data->app->title)) ?>"><?php echo $data->app->title;?></a></div>
