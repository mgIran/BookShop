...
<div class="tr">
    ...
    <div class="col-lg-2 col-md-2 hidden-sm hidden-xs"><?php echo Controller::fileSize(Yii::getPathOfAlias("webroot") . '/uploads/books/files/'.$data->app->platform->name.'/'.$data->file_name);?></div>
