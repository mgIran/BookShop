...
class BooksController extends Controller
{
    ...
    public function actionUpdate($id)
    {
        ...
        $appIconsDIR = Yii::getPathOfAlias("webroot") . '/uploads/books/icons/';
        $appImagesDIR = Yii::getPathOfAlias("webroot") . '/uploads/books/images/';
        $appIconsUrl = Yii::app()->createAbsoluteUrl('/uploads/books/icons');
        $appImagesUrl = Yii::app()->createAbsoluteUrl('/uploads/books/images');
        if ($model->platform) {
            ...
            $appFilesDIR = Yii::getPathOfAlias("webroot") . "/uploads/books/files/{$this->filesFolder}/";
            if (!is_dir($appFilesDIR))
                mkdir($appFilesDIR);
            $appFilesUrl = Yii::app()->createAbsoluteUrl("/uploads/books/files/{$this->filesFolder}");
        } else
    ...
    public function actionSavePackage()
    {
        if (isset($_POST['app_id'])) {
            ...
            if ($model->save()) {
                ...
                if ($_POST['platform'] == 'android') {
                    /* @var $app Books */
                    $app = Books::model()->findByPk($_POST['app_id']);
