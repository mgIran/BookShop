...
$book = $data->book;
if($book && $book->lastPrintedPackage->hasDiscount()) {
    ?>

    <div class="book-item <?=$book->lastPrintedPackage->hasDiscount()?'discount':''?>">
        <div class="book-item-content">
            <div class="pic">
                <div>
                    <a href="<?php echo Yii::app()->createUrl('/book/'.$book->id.'/'.urlencode($book->lastElectronicPackage->package_name)); ?>">
