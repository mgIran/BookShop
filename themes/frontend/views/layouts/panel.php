...
<div class="page-container">
    <div class="sidebar">
        ...
        <div class="list-group">
            ...
            <a data-toggle="tooltip" data-placement="left" title="دانلود شده ها" href="<?php echo Yii::app()->createUrl('/downloaded');?>" class="list-group-item<?php echo (Yii::app()->request->pathInfo=='downloaded')?' active':'';?>"><i class="downloaded-icon"></i><span class="text">دانلود شده ها</span></a>
