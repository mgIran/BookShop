...
<head>
    ...
    $cs->registerCssFile($baseUrl.'/css/bootstrap-panel-theme.css?3.6');
    $cs->registerCssFile($baseUrl.'/css/responsive-panel-theme.css?3.6');
    ...
    $cs->registerScriptFile($baseUrl.'/js/jquery.script.js?3.6', CClientScript::POS_END);
    $cs->registerScriptFile($baseUrl.'/js/panel.script.js?3.6', CClientScript::POS_END);
    ?>
</head>
<body>
