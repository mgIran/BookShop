...
<head>
    ...
    $cs->registerCssFile($baseUrl.'/css/bootstrap-panel-theme.css?3.7');
    $cs->registerCssFile($baseUrl.'/css/responsive-panel-theme.css?3.7');
    ...
    $cs->registerScriptFile($baseUrl.'/js/panel.script.js?3.7', CClientScript::POS_END);
    ?>
</head>
<body>
