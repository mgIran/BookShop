    ...
    <div class="sidebar">
        ...
        <?php if(Yii::app()->user->roles=='publisher'):?>
            <div class="list-group">
                ...
                <a data-toggle="tooltip" data-placement="left" title="سفارشات ثبت شده" href="<?php echo Yii::app()->createUrl('publishers/panel/orders');?>" class="list-group-item<?php echo (Yii::app()->request->pathInfo=='publishers/panel/orders')?' active':'';?>"><i class="cart-icon"></i><span class="text">سفارشات ثبت شده</span></a>
        ...
        <?php if(Yii::app()->user->roles=='seller'):?>
            <div class="list-group">
                <h5>فروشندگان</h5>
                <a data-toggle="tooltip" data-placement="left" title="کتاب ها" href="<?php echo Yii::app()->createUrl('sellers/panel');?>" class="list-group-item<?php echo (Yii::app()->request->pathInfo=='sellers/panel')?' active':'';?>"><i class="my-library-icon"></i><span class="text">کتاب ها</span></a>
                <a data-toggle="tooltip" data-placement="left" title="سفارشات ثبت شده" href="<?php echo Yii::app()->createUrl('sellers/panel/orders');?>" class="list-group-item<?php echo (Yii::app()->request->pathInfo=='sellers/panel/orders')?' active':'';?>"><i class="cart-icon"></i><span class="text">سفارشات ثبت شده</span></a>
                <a data-toggle="tooltip" data-placement="left" title="تخفیفات" href="<?php echo Yii::app()->createUrl('sellers/panel/discount');?>" class="list-group-item<?php echo (Yii::app()->request->pathInfo=='sellers/panel/discount')?' active':'';?>"><i class="discount-icon"></i><span class="text">تخفیفات</span></a>
                <a data-toggle="tooltip" data-placement="left" title="گزارش فروش" href="<?php echo Yii::app()->createUrl('sellers/panel/sales');?>" class="list-group-item<?php echo (Yii::app()->request->pathInfo=='sellers/panel/sales')?' active':'';?>"><i class="chart-icon"></i><span class="text">گزارش فروش</span></a>
                <a data-toggle="tooltip" data-placement="left" title="تسویه حساب" href="<?php echo Yii::app()->createUrl('sellers/panel/settlement');?>" class="list-group-item<?php echo (Yii::app()->request->pathInfo=='sellers/panel/settlement')?' active':'';?>"><i class="payment-icon"></i><span class="text">تسویه حساب</span></a>
                <a data-toggle="tooltip" data-placement="left" title="پروفایل فروشنده" href="<?php echo Yii::app()->createUrl('sellers/panel/account');?>" class="list-group-item<?php echo (Yii::app()->request->pathInfo=='sellers/panel/account')?' active':'';?>"><i class="user-icon"></i><span class="text">پروفایل فروشنده</span></a>
            </div>
        <?php endif;?>
    </div>
    <div class="content">
