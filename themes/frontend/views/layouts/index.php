...
<head>
    ...
    $cs->registerCssFile($baseUrl.'/css/bootstrap-theme.css?3.6');
    $cs->registerCssFile($baseUrl.'/css/responsive-theme.css?3.6');
    ...
    $cs->registerScriptFile($baseUrl.'/js/shop.script.js?3.6', CClientScript::POS_END);
